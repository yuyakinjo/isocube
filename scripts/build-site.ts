...
for (const file of ["index.html", "style.css"]) {
  await copyFile(new URL(`../web/${file}`, import.meta.url), new URL(file, destination));
}
await copyFile(new URL("../examples/logo.svg", import.meta.url), new URL("logo.svg", destination));
